-- Abilitazione estensione vector per embeddings
...
-- Bucket per storage dei documenti
INSERT INTO storage.buckets (id, name, public) VALUES ('documents', 'documents', true);
INSERT INTO storage.buckets (id, name, public) VALUES ('blog-images', 'blog-images', true);

-- Policies per storage
CREATE POLICY "Documenti pubblicamente accessibili" 
ON storage.objects 
FOR SELECT 
USING (bucket_id = 'documents');

CREATE POLICY "Utenti autenticati possono caricare documenti" 
ON storage.objects 
FOR INSERT 
WITH CHECK (bucket_id = 'documents' AND auth.uid() IS NOT NULL);

CREATE POLICY "Immagini blog pubblicamente accessibili" 
ON storage.objects 
FOR SELECT 
USING (bucket_id = 'blog-images');

CREATE POLICY "Utenti autenticati possono caricare immagini blog" 
ON storage.objects 
FOR INSERT 
